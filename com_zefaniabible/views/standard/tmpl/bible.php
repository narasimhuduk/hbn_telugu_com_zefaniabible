...
class BibleView {
	...
	{	
		...
		//echo "Name: ".$item->str_Bible_Version;
		$translation_lang = "";
        ...
        <form action="<?php echo JFactory::getURI()->toString(); ?>" method="post" id="adminForm" name="adminForm">
            <div id="zef_Bible_Main<?php if($item->str_tmpl == "component"){?>_tmpl_comp<?php }?>">
                <div class="zef_legend">
                    ...
                    <?php } ?>
                    <div class="zef_bible_Header_Label"><h1 class="zef_bible_Header_Label_h1"><?php echo JText::_('ZEFANIABIBLE_BIBLE_BOOK_NAME_'.$item->int_Bible_Book_ID.$translation_lang)." ".mb_strtolower(JText::_('ZEFANIABIBLE_BIBLE_CHAPTER'.$translation_lang),'UTF-8')." ".$item->int_Bible_Chapter; ?></h1></div>
                    ...
                    <?php }?>                
                    <div class="zef_book_label"><?php echo JText::_('ZEFANIABIBLE_BIBLE_BOOK'.$translation_lang);?></div>
                    <div class="zef_book">
                    ...
                    <?php if($item->str_tmpl == "component"){?>
                        <div style="clear:both;"></div>
                    <?php }?>
                    <div class="zef_chapter_label"><?php echo JText::_('ZEFANIABIBLE_BIBLE_CHAPTER'.$translation_lang);?></div>
		...
		foreach($arr_single_ref as $obj_single_ref)
		{
			for($x = 1; $x <= 66; $x++)
			{
...

				{
					...
					$str_bible_book_name =  JText::_('ZEFANIABIBLE_BIBLE_BOOK_NAME_'.$int_Bible_Book_ID.$translation_lang);
